...
export const StructuresSection = ({
  ...
  description = "The Ministry of Rural Development and Economic Empowerment is dedicated to transforming rural communities through capacity-building, infrastructure development, and community-based initiatives in Imo State.",
  departments,
