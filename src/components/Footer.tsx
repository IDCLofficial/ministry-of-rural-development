...
const info = {
    ...
    ministry: "MINISTRY OF RURAL DEV. AND ECONOMIC EMPOWERMENT",
    description: "The MINISTRY OF RURAL DEV. AND ECONOMIC EMPOWERMENT was created by the administration of His Excellency, Distinguished Senator Hope Uzodinma: the Governor of Imo State to facilitate the transformation of Imo State ",
    quickLinks: [
        {
            label: "Projects",
            href: "/projects" 
