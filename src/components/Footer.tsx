...
const info = {
    ...
    contact: [
        ...
        {
            label: "info.imominofruraldevelopment@gmail.com",
            href: "mailto:info.imominofruraldevelopment@gmail.com"
        },
    ]
}
...
export default function Footer() {
    ...
    return (
      ...
      <div className="mx-auto flex flex-col lg:flex-row justify-between gap-8 pb-8 max-w-5xl">
        ...
        Copyright © {new Date().getFullYear()} Imo State Ministry of Rural Development and Economic Empowerment. All rights reserved. Powered by{' '}
        <a 
